...
def test_tcp_session_test_safety_guards():
    ...
    # 4. Memory floor and 131k ceiling
    assert 'const EXTREME_MEMORY_FLOOR_MB: usize = 150;' in content, "Extreme memory floor must be at least 150MB"
    assert 'const ABSOLUTE_CONNECTION_LIMIT: usize = 131_072;' in content, "Limit must be 131072"
...
if __name__ == "__main__":
    ...
    print("ALL PYTHON RELAY 0.2.45 SAFETY AND MULTI-TARGET TESTS PASSED!")
